    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (isOnline()) {
            ...
            try {
                ...
                alertDialog.setButton(AlertDialog.BUTTON_POSITIVE, "Retry", (dialog, which) -> recreate());
                alertDialog.setButton(AlertDialog.BUTTON_NEGATIVE, "Exit", (dialog, which) -> finish());
                alertDialog.show();
            } catch (Exception e) {
