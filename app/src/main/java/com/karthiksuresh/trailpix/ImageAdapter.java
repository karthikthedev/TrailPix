            ...
            shareBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (downloadManager != null) {
                        ...
                        // Implement a BroadcastReceiver or check periodically using a Handler to confirm the download completion
                        // before attempting to share the file
                        shareImage(file, v); // Share the image only if it has been successfully downloaded
                    } else {
...
//        }
        ...
        private void shareImage(File imageFile, View v) {
            if (imageFile == null || !imageFile.exists()) {
                Toast.makeText(v.getContext(), "File does not exist", Toast.LENGTH_SHORT).show();
                return;
            }
            ...
            try {
                ...
                Uri imageUri = FileProvider.getUriForFile(
                        v.getContext(),
                        "com.karthiksuresh.trailpix.fileprovider", // Ensure this matches your Manifest
                        imageFile
                );
                ...
                e.printStackTrace();
                Toast.makeText(v.getContext(), "Error sharing image", Toast.LENGTH_SHORT).show();
            }
        }
